...
// src/docker-network.js
var IsPost = !!process.env["STATE_isPost"];
var NETWORK_NAME = "dockerNetworkName";
async function run() {
  try {
    info("Docker Network");
    saveState("isPost", "true");
    const name = getInput("name", { required: true });
    saveState(NETWORK_NAME, name);
...
async function cleanup() {
  info("Docker Network :: Cleanup");
  const name = getState(NETWORK_NAME);
...
*/
//# sourceMappingURL=docker-network.js.map

/*! cruglobal-dot-github v2.5.0 | MIT */
...
var flightdeck_release_event_exports = {};
__export(flightdeck_release_event_exports, {
  DEFAULT_ENDPOINT: () => DEFAULT_ENDPOINT,
  FlightdeckClient: () => FlightdeckClient,
  KINDS: () => KINDS,
  buildEvent: () => buildEvent,
  buildNumberFromTag: () => buildNumberFromTag,
  normalizeEndpoint: () => normalizeEndpoint,
  parseReasons: () => parseReasons,
  run: () => run,
  shaFromTags: () => shaFromTags
});
module.exports = __toCommonJS(flightdeck_release_event_exports);
...
async function run() {
  ...
  try {
    ...
    warning(`Flightdeck release event not recorded (non-blocking): ${error.message}`);
    setOutput("status", "failed");
  }
}
